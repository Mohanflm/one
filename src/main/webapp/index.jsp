...
<body>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Mayank, a DevOps Engineer passionate about optimizing workflows and delivering scalable, automated solutions. I specialize in tools like Jenkins, Docker, Kubernetes, Terraform, and cloud platforms such as AWS and Azure.</p>
    </section>
    ...
    <footer>
        <p>© 2024 Mayank | DevOps Engineer Portfolio | <a href="#about">Back to Top</a></p>
    </footer>
</body>
</html>
